...
function fixUserRoutes() {
  ...
  const userRoutesPath = path.join(__dirname, '..', 'src', 'routes', 'userRoutes.ts');
  ...
  userRoutesContent = userRoutesContent.replace(
    /router\.delete\(\s*['"]users\/:userId\/topics\/:topicId\/categories\/:categoryType\/materials\/:materialId['"]/,
