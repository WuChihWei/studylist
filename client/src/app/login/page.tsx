...
const LoginPage = () => {
  ...
  const handleSocialLogin = async (provider: GoogleAuthProvider | FacebookAuthProvider) => {
    try {
      ...
      const response = await fetch(`http://localhost:4001/api/users/${userCredential.user.uid}`, {
        method: 'GET',
        headers: {
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-3xl font-semibold text-gray-900">Welcome to StudyList</h1>
            <p className="text-gray-500">Continue with your email or social accounts</p>
          </div>
